...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function encryptObject($array, ...$keys)
        {
                        /** @var \Leolopez\Encrypt\Classes\Encrypt $instance */
                        return $instance->encryptObject($array, ...$keys);
        }
                    /**
         ...
         * @static 
         */ 
        public static function decryptObject($array, ...$keys)
        {
                        /** @var \Leolopez\Encrypt\Classes\Encrypt $instance */
                        return $instance->decryptObject($array, ...$keys);
        }
                    /**
        ...
        {
                        /** @var \Leolopez\Encrypt\Classes\Encrypt $instance */
                        return $instance->encryptValue($value);
        }
                    /**
        ...
        {
                        /** @var \Leolopez\Encrypt\Classes\Encrypt $instance */
                        return $instance->decryptValue($value);
        }
                    /**
         ...
         * @static 
         */ 
        public static function encryptArray($array, ...$keys)
        {
                        /** @var \Leolopez\Encrypt\Classes\Encrypt $instance */
                        return $instance->encryptArray($array, ...$keys);
        }
                    /**
         * Encrypt a value of an array, specifying the fields to be encrypted.
         *
         ...
         * @static 
         */ 
        public static function decryptArray($array, ...$keys)
        {
                        /** @var \Leolopez\Encrypt\Classes\Encrypt $instance */
                        return $instance->decryptArray($array, ...$keys);
        }
...
namespace  { 
            ...
            class Encrypt extends \Leolopez\Encrypt\Facades\Encrypt {}
