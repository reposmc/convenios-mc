<template>
    <div data-app>
        ...
        <v-data-table :headers="headers" :items="recordsFiltered" sort-by="id" class="elevation-3 shadow p-3 mt-3">
            <template v-slot:top>
                <v-toolbar flat>
                        ...
                        <template v-slot:activator="{ on, attrs }">
                            <v-row>
                                ...
                                <v-col xs="6" sm="6" md="6" class="d-none d-md-block d-lg-block">
                                    <v-text-field dense label="Buscar" outlined type="text" class="" v-model="search"
                                        @keyup="searchValue()"></v-text-field>
                                </v-col>
                            </v-row>
                        </template>
