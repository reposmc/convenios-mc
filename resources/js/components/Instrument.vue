                ...
                <v-toolbar flat>
                    ...
                    <v-dialog v-model="dialog" max-width="1400px" persistent>
                        ...
                        <v-card class="flexcard" height="100%">
                            <v-card-title>
                                <h1
                                    class="mx-auto pt-3 mb-3 text-center black-secondary"
                                >
                                    {{ formTitle }}
                                </h1>
                            </v-card-title>
                    ...
                    <v-dialog v-model="dialogDelete" max-width="400px">
                        <v-card class="h-100">
                            <v-container>
                                <h3
                                    class="black-secondary text-center mt-3 mb-3"
                                >
                                    Eliminar registro
                                </h3>
                                <v-row>
                            ...
                            >
                                ...
                                <v-col cols="12" xs="12" sm="12" md="4">
                                    <base-input
                                        label="Monto"
                                        v-model.trim="
                                            $v.editedItem.concept_amount.$model
                                        "
                                        :validation="
                                            $v.editedItem.concept_amount
                                        "
                                        type="number"
                                    />
                                </v-col>
                                ...
                                <v-col cols="12" sm="12" md="12">
                                    <v-textarea
                                        label="Descripción"
                                        v-model="
                                            $v.editedItem.exonerated_description
                                                .$model
                                        "
                                        :validation="
                                            $v.editedItem.exonerated_description
                            ...
                            >
                                ...
                                <v-col cols="12" sm="12" md="6">
                                    <base-input
                                        ...
                                        v-model.trim="
                                            $v.editedItem.service_place_name
                                                .$model
                                        "
                                        :validation="
                                            $v.editedItem.service_place_name
                                ...
                                >
                                    <base-select-search
                                        label="Tarifa de dependencia"
                                        v-model.trim="
                                            $v.editedItem.tariff_hour.$model
                                        "
                                        :items="tariffs"
                                        item="type_charge"
                                ...
                                <v-col cols="12" sm="12" md="4">
                                    <base-input
                                        label="Monto"
                                        v-model="
                                            $v.editedItem.amount_hour.$model
                                        "
                                ...
                                >
                                    <base-input
                                        ...
                                        v-model.trim="
                                            $v.editedItem.not_charged_people
                                                .$model
                                        "
                                        :validation="
                                            $v.editedItem.not_charged_people
                                ...
                                >
                                    <base-select-search
                                        label="Tarifa de personas"
                                        v-model.trim="
                                            $v.editedItem.tariff_people.$model
                                        "
                                        :items="tariffs"
                                        item="type_charge"
                                        :validation="
                                            $v.editedItem.tariff_people
                                        "
                                    />
                                </v-col>
                                ...
                                <v-col cols="12" sm="12" md="4">
                                    <base-input
                                        label="Monto"
                                        v-model="
                                            $v.editedItem.amount_people.$model
                                        "
                                        :validation="
                                            $v.editedItem.amount_people
                                        "
                                        type="number"
                                        readonly
                                    />
