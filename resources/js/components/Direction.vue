<template>
    <div data-app>
      ...
      >
        <template v-slot:top>
          <v-toolbar flat>
            <v-toolbar-title>Direcciones Nacionales</v-toolbar-title>
            <v-spacer></v-spacer>
                  ...
                  <v-container>
                    ...
                    <v-row>
                      ...
                      <v-col cols="12" sm="12" md="12">
                        <base-input
                          label="Nombre"
                          v-model="$v.editedItem.national_direction_name.$model"
  ...
  export default {
    data: () => ({
      ...
      dialogDelete: false,
      headers: [
        { text: "NOMBRE", value: "national_direction_name" },
    ...
    methods: {
      async initialize() {
        ...
        const res = await directionApi.get().catch((error) => {
        ...
        this.records = res.data.directions;
        this.recordsFiltered = res.data.directions;
      },
      ...
      searchValue() {
        ...
        if (this.search != "") {
          this.records.forEach((record) => {
            let searchConcat = "";
            for (let i = 0; i < record.national_direction_name.length; i++) {
