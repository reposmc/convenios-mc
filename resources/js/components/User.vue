<template>
    <div data-app>
        ...
        <v-data-table :headers="headers" :items="recordsFiltered" :search="search" :options.sync="options"
            :server-items-length="total" :footer-props="{ itemsPerPageOptions: [50] }" :items-per-page="take"
            @update:options="updatePagination" :page.sync="actualPage" item-key="id" sort-by="name"
                ...
                <v-toolbar flat>
                    ...
                    <v-dialog v-model="dialog" max-width="700px" persistent>
                        <template v-slot:activator="{ on, attrs }">
                            <v-row>
                                <!-- <v-col align="right">
                                    <v-btn class="mb-2 btn-normal no-uppercase" v-bind="attrs" v-on="on" rounded
                                        @click="newUser()" :disabled="loading != false">
                                        Agregar
                                    </v-btn>
                                </v-col> -->
                                ...
                                <v-container>
                                    ...
                                    <v-row>
                                        ...
                                        <v-col cols="12" sm="6" md="6">
                                            <base-input label="Nombre" v-model="$v.editedItem.name.$model"
                                                :validation.sync="$v.editedItem.name" validationTextType="default"
                                                :validationsInput="{
                                                    required: true,
                                                    minLength: true,
                                                    maxLength: true,
                                        ...
                                        <!-- <v-col cols="12" sm="6" md="6">
                                            <base-input label="Apellidos" v-model="$v.editedItem.last_name.$model"
                                                :validation.sync="$v.editedItem.last_name" validationTextType="default"
                                                :validationsInput="{
                                                    required: true,
                                                    minLength: true,
                                                    maxLength: true,
                                        ...
                                        <!-- <v-col cols="12" sm="6" md="6">
                                            <base-input label="Contraseña" v-model="$v.editedItem.password.$model"
                                                :validation.sync="$v.editedItem.password" validationTextType="none"
                                                :type="typePassword" :min="1" autocomplete="off" :validationsInput="{
                                                    required: true,
                                                    minLength: true,
                                                    maxnLength: true,
                                        ...
                                        <template>
                                            ...
                                            <v-col cols="12" md="6">
                                                <base-select-search 
                                                label="Dependencia" 
                                                v-model.trim="$v.formDependencies.dependence_name.$model"
                                                :items="dependencies" 
