                    ...
                    @if (auth()->user()->hasRole('Administrador') == 'Administrador')
                        ...
                        <li class="text-center pb-1">
                            <a href="{{ url('/reports') }}" class="text-center">
                                <i class="material-icons md-18 mx-auto">assignment</i>
                            </a>
                            <a href="{{ url('/reports') }}">
                        ...
                        <div class="row p-0 m-0">
                            ...
                            <div class=" col-sm-4 col-md-6 d-none d-md-block d-lg-block d-xl-block">
                                <div class="col-4 col-sm-12">
                                    ...
                                    {{-- <h3 class="pt-4 fw-bold color-secondary mb-0">
                                        {{ config('app.name') }}
                                    </h3> --}}
                                    {{-- </a> --}}
                                    <h3 class="pt-4 fw-bold color-secondary mb-0">Sistema Institucional de Seguimiento de Convenios</h3>
                                </div>
                            </div>
                            <!-- Institution Name -->
